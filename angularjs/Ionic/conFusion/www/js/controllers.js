  ...
  // Create the registration modal that we will use later
    ...
    $ionicPlatform.ready(function() {
        ...
        $ionicPopover, $ionicModal) {
            ...
            $scope.dish = dish;
            $scope.showOpList = function($event){
            ...
            $scope.openSubmit = function(){
                $scope.subcomm_form.show();
            }
            $scope.closeSubmit = function(){
                $scope.subcomm_form.hide();
            }
        ...
        .controller('IndexController', ['$scope', '$stateParams', 'dish', 'promotion', 'leader', 'baseURL', 
        function($scope, $stateParams, dish, promotion, leader, baseURL) {
